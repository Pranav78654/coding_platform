    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white flex flex-col">
      ...
      >
        ...
        <div className="space-x-4">
          <Button className="bg-cyan-500 px-6 py-3 text-lg rounded-xl shadow-lg">Start Coding</Button>
          <Button variant="outline" className="px-6 py-3 text-lg rounded-xl">Join Room</Button>
        </div>
      </motion.section>

      {/* Features Section */}
      <section id="features" className="grid grid-cols-1 md:grid-cols-3 gap-8 px-12 py-16">
        {[
